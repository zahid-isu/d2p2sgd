...
def train(args, model, train_loader, optimizer, dp_label, privacy_engine, epoch, device):
...
def main():
    ...
    for dp_mode in [None, "RP","d2p2"]: 
        ...
        for epoch in range(args.start_epoch, args.epochs + 1):  #training loop
            ...
            losses, sigma, epsilon = train(args, model, train_loader, optimizer,dp_label, privacy_engine, epoch, device)
