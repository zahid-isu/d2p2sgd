...
"""
Runs EMNIST training with differential privacy.
...
def plot_combined_results(train_results, sigma, batch_size, seed):
    ...
    filename = f'log/CNN_emnist/{current_time}_sigma_{sigma}_batch_{batch_size}_seed_{seed}'
    fig.suptitle(f'CNN_EMNIST_sigma_{sigma}_batch_{batch_size}', fontsize=16)
